...
for line in lines:
    path = line.strip()
    left_image_path.append(os.path.join(path, 'view1.png'))
    right_image_path.append(os.path.join(path, 'view5.png'))
    # right_imageL_path.append(os.path.join(path, 'view5L.png'))
    # right_imageE_path.append(os.path.join(path, 'view5E.png'))
    left_disp_path.append(os.path.join(path, 'disp1.png'))
    right_disp_path.append(os.path.join(path, 'disp5.png'))

number_of_patches = 206079
patch_size = 11
pos_high = 0.5
neg_high = 6
neg_low = 1.5
